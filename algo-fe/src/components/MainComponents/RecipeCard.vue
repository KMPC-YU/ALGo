<template>
  <h3 class="font-weight-bold mb-2">레시피 BEST 10</h3>
  <hr>
        ...
        <div class="row row-cols-1 row-cols-md-5 g-4">
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는피자</h5>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는치킨</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는보쌈</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는떡볶이</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는초밥</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
        ...
        <div class="row row-cols-1 row-cols-md-5 g-4">
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는콜라</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
          ...
          <div class="col">
            <div class="card h-100">
              <img src="https://www.ccbk.co.kr/images/product/detail/product112.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는스프라이트</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
          ...
          <div class="col">
            <div class="card h-100">
              <img src="https://sitem.ssgcdn.com/37/63/81/item/1000034816337_i1_1100.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는웰치스</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
          ...
          <div class="col">
            <div class="card h-100">
              <img src="https://cdn.emetro.co.kr/data2/content/image/2018/11/15/0540/20181115000163.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는포카리</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
          ...
          <div class="col">
            <div class="card h-100">
              <img src="http://image.auction.co.kr/itemimage/17/b0/8f/17b08f2a56.jpg" class="card-img-top" alt="Hollywood Sign on The Hill"/>
              <div class="card-body">
                <h5 class="card-title fw-bold">맛있는갈배</h5>
                <ul class="list-unstyled list-inline mb-0">
                  <li class="list-inline-item me-0">
                    <i class="bi bi-star-fill text-warning"></i>
                  </li>
