  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div v-if="page === 0" class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div
                  ...
                  <h6 class="m-0 font-weight-bold text-primary">작성된 게시글 추이</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div
                  class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">작성된 레시피 카테고리</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
        ...
        <!-- Boards Page Content -->
        <div v-if="page === 1" class="container py-5">
        <h1>게시판 생성</h1>
